...
{
    public class ReorderPlaylistItems
    {
        /// <summary>
        /// Required. The position of the first item to be reordered.
        /// </summary>
        public int RangeStart { get; set; }

        /// <summary>
        /// Optional. The amount of items to be reordered.
        ...
        /// <summary>
        /// 	Required. The position where the items should be inserted.
        ...
        /// <summary>
        /// Optional. The playlist’s snapshot ID against which you want 
        /// to make the changes.
        /// </summary>
